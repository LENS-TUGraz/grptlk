...
# Single source of truth for BIS channel count in sysbuild/nRF53 builds.
# Use SB_CONFIG_GRPTLK_ISO_CHAN_COUNT.
set_config_int(${DEFAULT_IMAGE} CONFIG_GRPTLK_ISO_CHAN_COUNT
  ${SB_CONFIG_GRPTLK_ISO_CHAN_COUNT})
set_config_int(${DEFAULT_IMAGE} CONFIG_BT_ISO_MAX_CHAN
  ${SB_CONFIG_GRPTLK_ISO_CHAN_COUNT})

if(SB_CONFIG_NET_CORE_IMAGE_HCI_IPC)
  # For builds on the nRF5340, we build the netcore image with the controller.

  set(NET_APP hci_ipc)
  set(NET_APP_SRC_DIR ${ZEPHYR_BASE}/samples/bluetooth/${NET_APP})
  get_filename_component(NETCORE_CONF "${CMAKE_CURRENT_LIST_DIR}/netcore.conf" ABSOLUTE)
  math(EXPR NETCORE_UL_BIS_COUNT "${SB_CONFIG_GRPTLK_ISO_CHAN_COUNT} - 1")
  ...
  set_config_int(${NET_APP} CONFIG_BT_CTLR_ADV_ISO_STREAM_COUNT
    ${SB_CONFIG_GRPTLK_ISO_CHAN_COUNT})
  # Broadcaster receives on MAX-1 uplink BISes (BIS2..BISn).
